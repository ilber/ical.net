...
namespace Ical.Net.Interfaces.Components
{
	public interface IAlarm : ICalendarComponent
	{
		...
		/// </summary>
		IList<IAlarmOccurrence> GetOccurrences(IRecurringComponent rc, IDateTime fromDate, IDateTime toDate);
		...
		IList<IAlarmOccurrence> Poll(IDateTime fromDate, IDateTime toDate);
	}
}